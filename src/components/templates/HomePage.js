          ...
          <article className='w-full h-full lg:flex lg:flex-row-reverse mt-10'>
            ...
            <div className='p-4 text-mainTxtColor lg:w-3/4'>
              ...
              <p className=' lg:h-full lg:w-full'>
                ...
                environment. With the advancement in smartphones and technology,
                has allowed us to use this technology to create an environment
                where Luxury designs merge with electrical equipment is
                controlled by a single smart device. There is continued research
                and development to create energy-efficient smart automation and
                we keep fully up to date on the latest technology to offer our
                clients.
              </p>
            </div>
          </article>
